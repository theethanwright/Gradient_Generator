...
const material = new THREE.ShaderMaterial({
    uniforms: {
      ...
      alphaNoiseStrength: { value: 1.0 } // New uniform for alpha noise strength
    },
    vertexShader: `
      uniform float time;
    ...
    fragmentShader: `
      ...
      uniform float alphaNoiseStrength; // New uniform for alpha noise strength
      ...
      void main() {
        ...
        float alpha = mix(edgeAlpha, color.a * (alphaNoise * 0.5 + 0.5) * alphaNoiseStrength, edgeFactor); // Apply alpha noise strength
...
const params = {
  ...
  alphaNoiseStrength: 1.0 // New parameter for alpha noise strength
};
...
// New control for alpha noise strength
