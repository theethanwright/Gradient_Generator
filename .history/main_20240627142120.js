...
function createPlaneGeometry() {
  return new THREE.PlaneGeometry(10, 5, 100, 100);
}
...
const material = new THREE.ShaderMaterial({
  uniforms: {
    time: { value: 0 },
    color1: { value: new THREE.Vector4(255 / 255, 108 / 255, 2 / 255, 1) }, // Purple
    color2: { value: new THREE.Vector4(1 / 255, 26 / 255, 255 / 255, 1) },   // Green
    color3: { value: new THREE.Vector4(250 / 255, 23 / 255, 255 / 255, 1) },   // Blue
    edgeAlpha: { value: 0.0 },
    noiseScale: { value: 1.0 },
    distortionStrength: { value: 2 },
    colorNoiseScale: { value: 0.2 },
    alphaNoiseScale: { value: 0.2 },
    distortionNoiseScale: { value: 0.2 },
    alphaNoiseStrength: { value: 2.0 }
  },
  vertexShader: `
    uniform float time;
