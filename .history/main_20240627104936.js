...
function updateColor(colorUniform, colorArray) {
...
gui.addColor(params, 'color1').onChange((value) => updateColor(material.uniforms.color1, value));
gui.addColor(params, 'color2').onChange((value) => updateColor(material.uniforms.color2, value));
gui.addColor(params, 'color3').onChange((value) => updateColor(material.uniforms.color3, value));
